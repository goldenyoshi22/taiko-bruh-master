function convertLanguage(lang) {
	switch (lang) {
		case "JP":
			...
			selected.settings.names[4] = "最大のFPS";
			selected.settings.names[5] = "最大のTPS";
			selected.settings.names[6] = ".tjaアップロードする";
			...
			selected.settings.descriptions[4] = "ゲームの最大FPS設定する。";
			selected.settings.descriptions[5] = "ゲームの最大TPS設定する。\n(TPSとは1秒のティック数です)";
